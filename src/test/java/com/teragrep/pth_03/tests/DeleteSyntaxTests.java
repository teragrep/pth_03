...
public class DeleteSyntaxTests {
    ...
    public void deleteSyntaxParseTest(String arg) throws Exception {
        String fileName = "src/test/resources/antlr4/commands/delete/" + arg + ".txt";
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/delete/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/deleteTransformation/value";
