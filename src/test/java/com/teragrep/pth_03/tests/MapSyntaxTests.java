...
public class MapSyntaxTests {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/map/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/mapTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/map/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/mapTransformation/stringType/value";
    ...
    void xpathTest3(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/map/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/mapTransformation/t_map_maxsearchesOptParameter/integerType/value";
    ...
    void xpathTest4(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/map/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/mapTransformation/t_map_searchoptionParameter/stringType/value";
