...
public class StrcatSyntaxTests {
    @ParameterizedTest(name = "{index} command=''{0}''")
    @ValueSource(strings = {
            "strcat",
    })
    public void strcatSyntaxParseTest(String arg) throws Exception {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/strcat/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/strcatTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/strcat/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/strcatTransformation/t_strcat_allrequiredParameter/booleanType/value";
    ...
    void xpathTest3(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/strcat/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/strcatTransformation/t_strcat_srcfieldsParameter/fieldType[1]/value";
