...
//    FIXME XML is incomplete for savedsearch3.
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/savedsearch/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/savedsearchTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/savedsearch/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/savedsearchTransformation/stringType/value";
    ...
    void xpathTest3(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/savedsearch/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/savedsearchTransformation/t_savedsearch_savedsearcMacroOptParameter/booleanType/value";
