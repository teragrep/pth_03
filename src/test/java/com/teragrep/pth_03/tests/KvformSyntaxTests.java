...
//    FIXME kvform4.txt is empty.
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/kvform/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/kvformTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/kvform/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/kvformTransformation/t_kvform_formParameter/stringType/value";
    ...
    void xpathTest3(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/kvform/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/kvformTransformation/t_kvform_fieldParameter/fieldType/value";
