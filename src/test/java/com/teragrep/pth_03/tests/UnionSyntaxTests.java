...
public class UnionSyntaxTests {
    @ParameterizedTest(name = "{index} command=''{0}''")
    @ValueSource(strings = {
            "union",
    })
    public void unionSyntaxParseTest(String arg) throws Exception {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/union/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/unionTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/union/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/unionTransformation/t_union_datasetParameter[1]/t_union_namedDatasetParameter/t_union_datasetTypeParameter/value";
    ...
    void xpathTest3(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/union/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/unionTransformation/t_union_datasetParameter[1]/t_union_namedDatasetParameter/stringType/value";
