...
public class RedistributeSyntaxTests {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/redistribute/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/redistributeTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ...
        String xpathExp = "/root/transformStatement/redistributeTransformation/t_redistribute_byInstruction/fieldListType/fieldType/value";
    ...
    void xpathTest4(String arg) throws Exception {
        ...
        String xpathExp = "/root/transformStatement/redistributeTransformation/t_redistribute_numOfReducersParameter/integerType/value";
