...
//    FIXME XML is incomplete.
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/sitop/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/sitopTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/sitop/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/sitopTransformation/fieldListType/fieldType[1]/value";
