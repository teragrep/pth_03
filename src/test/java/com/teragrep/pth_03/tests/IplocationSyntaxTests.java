...
public class IplocationSyntaxTests {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/iplocation/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/iplocationTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/iplocation/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/iplocationTransformation/t_iplocation_prefixParameter/stringType/value";
    ...
    void xpathTest3(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/iplocation/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/iplocationTransformation/t_iplocation_allFieldsParameter/booleanType/value";
    ...
    void xpathTest4(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/iplocation/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/iplocationTransformation/t_iplocation_langParameter/stringType/value";
    ...
    void xpathTest5(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/iplocation/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/iplocationTransformation/fieldType/value";
