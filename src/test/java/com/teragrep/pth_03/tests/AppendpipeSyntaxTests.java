...
public class AppendpipeSyntaxTests {
    @ParameterizedTest(name = "{index} command=''{0}''")
    @ValueSource(strings = {
            "appendpipe",
    })
    public void appendpipeSyntaxParseTest(String arg) throws Exception {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/appendpipe/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/appendpipeTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/appendpipe/" + arg + ".txt";
        String xpathExp = "/root/transformStatement[1]/appendpipeTransformation[1]/t_appendpipe_run_in_previewParameter[1]/booleanType[1]/value[1]/text()[1]";
