...
public class MultisearchSyntaxTests {
    @ParameterizedTest(name = "{index} command=''{0}''")
    @ValueSource(strings = {
            "multisearch",
    })
    public void multisearchSyntaxParseTest(String arg) throws Exception {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/multisearch/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/multisearchTransformation";
