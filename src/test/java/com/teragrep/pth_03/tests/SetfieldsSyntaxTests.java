...
public class SetfieldsSyntaxTests {
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/setfields/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/setfieldsTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ParserStructureTestingUtility pstu = new ParserStructureTestingUtility();
        String fileName = "src/test/resources/antlr4/commands/setfields/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/setfieldsTransformation/t_setfields_setfieldsParameter[1]/stringType[2]/value";
