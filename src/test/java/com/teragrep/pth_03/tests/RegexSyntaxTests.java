...
public class RegexSyntaxTests {
    @ParameterizedTest(name = "{index} command=''{0}''")
    @ValueSource(strings = {
            "regex",
    })
    public void regexSyntaxParseTest(String arg) throws Exception {
        String fileName = "src/test/resources/antlr4/commands/regex/" + arg + ".txt";
    ...
    void xpathTest1(String arg) throws Exception {
        ...
        String fileName = "src/test/resources/antlr4/commands/regex/" + arg + ".txt";
        String xpathExp = "/root/transformStatement/regexTransformation";
    ...
    void xpathTest2(String arg) throws Exception {
        ...
        String xpathExp = "/root/transformStatement/regexTransformation/regexStringType/value";
