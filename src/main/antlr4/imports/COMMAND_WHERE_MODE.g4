...
// ++++++++++++++ COMMAND_WHERE_MODE ++++++++++++++
mode COMMAND_WHERE_MODE;

// skip
COMMAND_WHERE_MODE_SPACE: SPACE -> channel(HIDDEN);

// exits
COMMAND_WHERE_MODE_PIPE: '|' -> type(PIPE), popMode;
COMMAND_WHERE_MODE_BRACKET_R: ']' -> type(BRACKET_R), popMode, popMode;

// tokens

COMMAND_WHERE_MODE_COMMENT: '<!--' .*? '-->' -> channel(DPLCOMMENT);
